...
if( $values[0] eq "Mostly Cloudy" || $values[0] eq "Cloudy" || $values[0] eq "Dreary (Overcast)" || $values[0] eq "Intermittent Clouds")
{
my $cloud = "";
binmode(STDOUT, ":utf8");
print "$cloud";
...
if( $values[0] eq "Windy"  || $values[0] eq "Thunderstorms")
{
my $wind = "";
binmode(STDOUT, ":utf8");
print "$wind";
